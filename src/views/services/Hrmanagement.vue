<template>
  ...
  <div class="full-width bg-bg-2 font-pop">
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center">
      <div class="text-center mb-[35px] md:mb-[43px]">
        ...
        <p class="font-pop md:text-lead-lg text-gray-600 mx-auto max-w-[976px]">Outsourcing Human Resource services
          offers a great advantage to our customers, we acts as the Human Resource focal point on behalf of the
          Organization to enable organizations to Reduced cost, Increased efficiency, Access to improved Human Resource
          IT systems, Improved management information (including human capital metrics), Access to Human Resource
          expertise not available internally, Increased flexibility and speed of response, Reduced risk, To free Human
          Resource to operate more strategically.</p>
      </div>
    </div>
  </div>
  ...
  <div class="container mx-auto">
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px]">
      <div class="lg:grid lg:grid-cols-2 gap-[80px]">
        <div class="relative">
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mb-[50px]">
              <div class="rounded-2xl py-[35px] px-[24px] border border-gray-200 card-shadow group cursor-pointer transition-all duration-200 hover:bg-green-900 hover:-translate-y-1">
                ...
                <ul class="py-8 list-disc px-[24px] font-pop text-base">
                  ...
                  <li class="py-2">We manage their performance</li>
                  <li class="py-2">We provide Monthly Contract Management Report</li>
                </ul>
              </div>
              ...
              <div class="rounded-2xl py-[35px] px-[24px] border border-gray-200 card-shadow group cursor-pointer transition-all duration-200 hover:bg-green-900 hover:-translate-y-1">
                ...
                <ul class="py-8 list-disc px-[24px] font-pop text-base">
                  ...
                  <li class="py-2">We manage the performance</li>
                  <li class="py-2">We manage exits</li>
                  <li class="py-2">Monthly meeting with management</li>
                </ul>
              </div>
              ...
              <div class="rounded-2xl py-[35px] px-[24px] border border-gray-200 card-shadow group cursor-pointer transition-all duration-200 hover:bg-green-900 hover:-translate-y-1">
                ...
                <ul class="py-8 list-disc px-[24px] font-pop text-base">
                  ...
                  <li class="py-2">We advise in case of Manapower planning, Exit management, Compliancies</li>
                </ul>
              </div>
              ...
              <div class="rounded-2xl py-[35px] px-[24px] border border-gray-200 card-shadow group cursor-pointer transition-all duration-200 hover:bg-green-900 hover:-translate-y-1">
                ...
                <ul class="py-8 list-disc px-[24px] font-pop text-base">
                  ...
                  <li class="py-2">Statutory computation and remittence</li>
                  <li class="py-2">Monthly reports</li>
                </ul>
              </div>
        ...
        <div class="flex-1 order-1 lg:gap-[30px] xl:gap-[64px]"><span
          ...
          <h3
            ...
            Human Resource Management Options</h3>
          <p class="text-quote md:text-lead-lg text-gray-600 mb-[50px]">Our Human Resource Management Services are
            tailored to best suit your business operation needs.</p>
