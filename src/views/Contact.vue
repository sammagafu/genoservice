    ...
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[138px]">
        ...
        <div class="justify-between lg:flex lg:items-center gap-[30px]">
          <div class="flex items-start gap-5 transition-all duration-300 mb-[33px] hover:translate-y-[-3px] border-b border-gray-200 pb-[50px] last:mb-0">
            <img class="h-full w-full object-cover max-w-[64px]" src="@/assets/img/icon/placeholder.png" alt="icon">
            <div> 
              <h3 class="font-bold font-pop text-[20px] leading-[26px] md:text-heading-4 mb-[14px]">Pay us a visit
              </h3>
      ...
      <div class="full-width pt-16">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.659526799497!2d39.28309341484424!3d-6.811203381636658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x185c4b4d45b95c79%3A0xf4f1aa090b47d482!2sFNB%20House!5e0!3m2!1sen!2stz!4v1661166181332!5m2!1sen!2stz" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
</div>
</template>