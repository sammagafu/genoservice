  ...
  <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px]">
    <div class="text-center mb-[35px] md:mb-[43px]">
      <h2
        ...
        Our Story</h2>
      <p class="font-pop md:text-lead-lg text-gray-600 mx-auto max-w-[976px]">GENO Services Limited is a Tanzanian firm,
      ...
      <p class="font-pop md:text-lead-lg text-gray-600 mx-auto max-w-[976px]">25+ years of Human Resource Experiences of
      ...
      <p class="font-pop md:text-lead-lg text-gray-600 mx-auto max-w-[976px]">Our Advisors and Consultants are
        Experienced and Certified members of the globally recognized Professional Institutions.</p>
      <p class="font-pop md:text-lead-lg text-gray-600 mx-auto max-w-[976px]">Our exceptional innovative approach to
